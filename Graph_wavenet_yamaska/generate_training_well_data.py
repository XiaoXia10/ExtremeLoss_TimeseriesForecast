...
if __name__ == "__main__":
    ...
    forecast = 5
    parser.add_argument("--output_dir", type=str, default="data/GWN_"+str(forecast), help="Output directory.")
    ...
    parser.add_argument("--df_train", type=str, default="data/train_val_data.csv", help="df for train and validation.",)
    parser.add_argument("--df_test", type=str, default="data/test_data.csv", help="df for testing.",)
    ...
    parser.add_argument("--train_split", type=float, default=0.8, help="The percentage split for training and val.",)

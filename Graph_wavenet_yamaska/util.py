...
def extreme_value_loss(y_true, y_pred, alpha=2.7):
    """
...
def get_shared_arg_parser(forecast = 5, loss = "extreme"):
    
    parser = argparse.ArgumentParser()
    
    parser.add_argument('--device', type=str, default='cuda', help='')
    parser.add_argument('--adjdata', type=str, default='adj_mat/adj_mat.npy', help='adj matrix path')
    ...
    parser.add_argument('--data', type=str, default="data/GWN_"+str(forecast), help='data path')
    parser.add_argument('--save', type=str, default="data/GWN_"+str(forecast)+"/experiment_"+str(forecast)+"_"+loss, help='save path')

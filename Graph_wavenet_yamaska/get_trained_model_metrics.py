...
def get_metrics(args):
    ...
    if args.scale_data == True:
        ...
        yhat, realy = load_loader_data(args.data_dir, args.time_dir, args.loader)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="data/GWN_"+str(forecast)+"/experiment_"+str(forecast)+"_"+loss, help="Data directory")
    parser.add_argument("--time_dir", type=str, default="data/GWN_"+str(forecast), help="Time directory")
   
    parser.add_argument("--scale_data", type=str, default=True, help="To scale data")

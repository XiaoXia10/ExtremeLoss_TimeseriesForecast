...
def generate_train_val_test(args):
    ...
    print("The files are saved in the output directory")
    return x_train, y_train, x_val, y_val, x_test, y_test

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    forecast = 9
    parser.add_argument("--output_dir", type=str, default="data_H/GWN_"+str(forecast), help="Output directory.")
    
    parser.add_argument("--df_path", type=str, default="data_H", help="df path",)
    # parser.add_argument("--time_dir", type=str, default="data_H/GWN_12", help="Time directory")
    
    parser.add_argument("--df_train", type=str, default="data_H/train_val_data.csv", help="df for train and validation.",)
    parser.add_argument("--df_test", type=str, default="data_H/test_data.csv", help="df for testing.",)
    ...
    parser.add_argument("--train_split", type=float, default=0.9, help="The percentage split for training and val.",)

...
def main(args, **model_kwargs):
    ...
    lowest_loss_yet = 1000 # keep this to be a high value, will get overwritten
    ...
    for _ in mb:
        ...
        for iter, (x, y) in enumerate(data['train_loader'].get_iterator()):
            ...
            loss, mape, rmse = engine.train(trainx, y_real, extreme_loss=args.extreme_loss)
    ...
    if args.plot_history == True:
        tr_val = loss_curve(args.save)
        plot_loss_curve(args.save)

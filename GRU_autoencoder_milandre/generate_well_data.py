...
if __name__ == "__main__":
    ...
    parser.add_argument("--df_train", type=str, default="data_"+timestep+"\train_val_data.csv", help="df for train and validation.",)
    parser.add_argument("--df_test", type=str, default="data_"+timestep+"\test_data.csv", help="df for testing.",)
    
    parser.add_argument("--output_dir", type=str, default="data_"+timestep+"\GRU"+str(seq_length_x)+str(seq_length_y)+str(shift), help="df for testing.",)
    
    parser.add_argument('--train_percent', type=float, default=0.9, help='The percentage of data used for model training')
